...
// lib/screens/tutorials_screen.dart
...
//                           Media media = tutorial.media![mediaIndex];
//                           return Center(
//                             child: Container(
...
//                                   InkWell(
//                                     onTap: () async {
//                                       tutorialController.launchInBrowser(
//                                           tutorial.videoLink ?? "");
//                                     },
//                                     child: Container(
//                                       decoration: BoxDecoration(
...
//                                           fit: BoxFit.cover,
//                                           imageUrl: tutorial.getPreviewUrl(),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: tutorial.media?.length ?? 0,
                        itemBuilder: (context, mediaIndex) {
                          Media media = tutorial.media![mediaIndex];
                          return Center(
                            child: Container(
